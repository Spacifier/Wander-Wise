...
function Travel(){
    ...
    return (
       <div className="h-screen w-screen flex flex-col wrapper">
            <h2 className="text-5xl font-[orkney] mt-15">
                Explore Latest Trips
            </h2>
            <p className="text-md font-[nunito] mt-2 mb-15">
                Browse well-planned trips <br />
                designed for different travel styles and interests 
            </p>
            <div className="flex ">
