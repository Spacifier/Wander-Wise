...
function TravelCreate(){
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_BACKEND_HOST}/api/v1/trips/create-itinerary`,{
                method: "POST",
                headers:{
            ...
            if(res.ok && data?.tripDetail){
                navigate("/travel/itinerary", {
                    state: {
                        tripData: data.tripDetail,
    ...
    return (
       <main className="flex flex-col gap-10 pb-20 wrapper mt-25">
            <Header title="Create Your Own Trip" description="View and edit AI Genereated Travel Plans" />
